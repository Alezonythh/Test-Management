                    ...
                    <form method="GET" action="{{ route('admin.borrowedBooks') }}">
                        <div class="flex justify-center space-x-6">
                            <button type="submit" name="status" value="dipinjam"
                                class="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 {{ $status == 'dipinjam' ? 'bg-blue-600' : '' }}">
                                Buku yang Dipinjam
                            </button>
                            <button type="submit" name="status" value="dikembalikan"
                                class="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 {{ $status == 'dikembalikan' ? 'bg-blue-600' : '' }}">
                                Buku yang Dikembalikan
                            </button>
                            <button type="submit" name="status" value="overdue"
                                class="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 {{ $status == 'overdue' ? 'bg-blue-600' : '' }}">
                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                @foreach ($borrowedBooks as $borrow)
                                    ...
                                    @endphp
                                    <tr
                                        class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 {{ $rowClass }}">
                                        ...
                                        <td class="px-6 py-4">
                                            <span
                                                class="px-2 py-1 text-xs font-medium rounded-lg {{ $borrow->status === 'dipinjam' ? 'bg-yellow-100 text-yellow-800' : 'bg-green-100 text-green-800' }}">
                                                ...
                                                <div class="flex space-x-3 justify-center">
                                                    ...
                                                    <form action="{{ route('admin.extendLoan', $borrow->id) }}"
                                                        ...
                                                        <div class="flex items-center space-x-2">
                                                            ...
                                                            <button type="submit"
                                                                onclick="return confirm('Yakin Ingin Perpanjang?')"
                                                    ...
                                                    <button data-modal-target="returnModal-{{ $borrow->id }}"
                                                        ...
                                                        class="text-white bg-red-500 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
                                                        type="button">
                                                        Kembalikan
                                                    </button>
                                                </div>
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                                ...
                                <button type="button"
                                    ...
                                    data-modal-hide="returnModal-{{ $borrow->id }}">
                                    ...
                                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                                        ...
                                        <div class="sm:col-span-2">
                                            <label for="kondisi_akhir"
                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kondisi
                                                Akhir (Foto)</label>
                                            <input type="file" name="kondisi_akhir" id="kondisi_akhir"
